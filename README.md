...
```javascript
import FLOAT32_MAX_SAFE_NTH_DOUBLE_FACTORIAL from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-max-safe-nth-double-factorial@v0.1.0-esm/index.mjs';
```
