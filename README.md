...
```javascript
FLOAT32_MAX_SAFE_NTH_DOUBLE_FACTORIAL = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-max-safe-nth-double-factorial@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-max-safe-nth-double-factorial/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/constants-float32-max-safe-nth-double-factorial/actions/workflows/test.yml?query=branch:v0.1.1
